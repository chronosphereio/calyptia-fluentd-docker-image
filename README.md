...
```bash
docker run -d -p 24224:24224 -p 24224:24224/udp -v /data:/fluentd/log -e CALYPTIA_API_KEY=YOUR_API_KEY [-e CALYPTIA_ENDPOINT=http://localhost:5000]  fluent/fluentd:v1.3-beta-1
```
...
```console
$ docker run -it --rm -p 24224:24224 -p 24224:24224/udp -v /path/to/dir:/fluentd/etc -v /path/to/store/api_response:/fluentd/log/agent_state fluent/fluentd -c /fluentd/etc/<conf>
```
